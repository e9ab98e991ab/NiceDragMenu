...
public class AnimateImageView extends FloatingActionButton {
    ...
    public void animRefresh(int yPos){
        int xPos = (int) springY.getCurrentValue();
        setTranslationY(-yPos);
        springY.setEndValue(xPos);
        Log.e("***", "xPos:"+xPos +" yPos:"+ yPos);
    }
    public void animRefreshStop(int yPos){
        int xPos = (int) springX.getCurrentValue();
        setTranslationY(yPos);
        Log.e("***", "xPos:"+xPos +" yPos:"+ yPos);
    }
